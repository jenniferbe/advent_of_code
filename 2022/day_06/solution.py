...
device. He says that it has many fancy features, but the most important one to set
...
of characters from the beginning of the buffer to the end of the first such four-
character marker.
...
print("Message positions:")
get_first_marker_position(input_file, 14)
